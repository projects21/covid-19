...
$fetch_doc="SELECT * FROM doctors WHERE doc_id='{$doc_id}'";
$res_doc=mysqli_query($con,$fetch_doc);
$tot_rows=mysqli_num_rows($res_doc);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    <?php
                    if($tot_rows!=0){
                        while($data=mysqli_fetch_assoc($res_doc)){
                    ?>
                  <form method='GET' action='updt_doc.php'>
                  <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Doc id</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value='<?php echo $data['doc_id']?>' name='doc_id'>
                      </div>
                    </div>
                    <div class="form-group row">
